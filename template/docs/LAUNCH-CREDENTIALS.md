...
|---|---|---|
| Cloudflare account, **in the client's name**, Charlie added as a member | — | the client is locked to Charlie's personal account. Do this even if it costs an hour |
...
| **Who gets access** | whoever handles hiring, and Charlie. Not "everyone at the client" — this is the only route on the whole site that serves one person's private document to another |
